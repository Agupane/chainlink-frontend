...
export const POLLING_UPDATE_TIME: number = process.env.REACT_APP_POLLING_UPDATE_TIME_IN_SECONDS
    ? parseInt(process.env.REACT_APP_POLLING_UPDATE_TIME_IN_SECONDS) * 1000
    : 1000 * 5 // 5 seconds
